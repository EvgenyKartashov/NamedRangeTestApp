...
namespace NamedRangeTestApp.Extensions
{
    ...
    {
        public static IEnumerable<Cell> GetCells(this ExcelNamedRange cellRange)
        {
        ...
        public static void Insert(this ExcelNamedRange cellRange, string[] values)
        {
            var startCol = cellRange.Start.Column;
            var startRow = cellRange.Start.Row;
            ...
            var notInsertedValues = new List<string>();
        ...
        private static (int nextCol, int nextRow) InsertValue(this ExcelNamedRange cellRange, int currentCol, int currentRow, string value)
        {
            var colNum = cellRange.Columns;
            var rowNum = cellRange.Rows;
            var startCol = cellRange.Start.Column;
